...
import { PostSignup } from '@services/user/userApi';
...
const SignUp = () => {
    ...
    return (
        <div>
            ...
            <FormInput name="password" label={'패스워드'} onChange={setSignupFormValue} />
            <FormInput name="nickname" label={'닉네임'} onChange={setSignupFormValue} />

            <FormFile name="profileImageUrl" type={'single'} label={'프로필 이미지'} onChange={setSignupFormValue} />
