...
import { categoryInfo } from '@state/post/selectors/categorySelector';
...
function PostRegister() {
    ...
    return (
        <div>
            ...
            <DatePicker name="startedAt" label={'시작일'} setValue={setPostForm} value={postForm} />
            <DatePicker name="endedAt" label={'종료일'} setValue={setPostForm} value={postForm} />
